...
///
/// \if UNICODE
///   \sa TBarCtlsLibU::IOLEDataObject, ReBar, ToolBar,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \else
///   \sa TBarCtlsLibA::IOLEDataObject, ReBar, ToolBar,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \endif
//////////////////////////////////////////////////////////////////////
...
public:
	...
	///
	/// \if UNICODE
	///   \sa SetDropDescription, ReBar::get_SupportOLEDragImages, ToolBar::get_SupportOLEDragImages,
	...
	///
	/// \if UNICODE
	///   \sa GetDropDescription, ReBar::put_SupportOLEDragImages, ToolBar::put_SupportOLEDragImages,
	///       TBarCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa GetDropDescription, ReBar::put_SupportOLEDragImages, ToolBar::put_SupportOLEDragImages,
