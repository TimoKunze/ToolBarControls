...
protected:
	...
	struct Properties
	{
		...
		struct DisabledEventsItemIndices
		{
			...
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			///   \sa TBarCtlsLibA::DisabledEventsConstants
			/// \endif
			int deMouseEvents;
			...
			/// \brief <em>Holds the zero-based index of the item representing the \c deBandInsertionEvents flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			///   \sa TBarCtlsLibA::DisabledEventsConstants
			/// \endif
			int deBandInsertionEvents;
			/// \brief <em>Holds the zero-based index of the item representing the \c deButtonInsertionEvents flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			///   \sa TBarCtlsLibA::DisabledEventsConstants
			/// \endif
			int deButtonInsertionEvents;
			/// \brief <em>Holds the zero-based index of the item representing the \c deBandDeletionEvents flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			///   \sa TBarCtlsLibA::DisabledEventsConstants
			/// \endif
			int deBandDeletionEvents;
			/// \brief <em>Holds the zero-based index of the item representing the \c deButtonDeletionEvents flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			///   \sa TBarCtlsLibA::DisabledEventsConstants
			/// \endif
			int deButtonDeletionEvents;
			/// \brief <em>Holds the zero-based index of the item representing the \c deFreeBandData flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			...
			/// \endif
			int deFreeBandData;
			/// \brief <em>Holds the zero-based index of the item representing the \c deFreeButtonData flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			///   \sa TBarCtlsLibA::DisabledEventsConstants
			/// \endif
			int deFreeButtonData;
			/// \brief <em>Holds the zero-based index of the item representing the \c deCustomDraw flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			...
			/// \endif
			int deCustomDraw;
			/// \brief <em>Holds the zero-based index of the item representing the \c deHotButtonChangeEvents flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			///   \sa TBarCtlsLibA::DisabledEventsConstants
			/// \endif
			int deHotButtonChangeEvents;
			/// \brief <em>Holds the zero-based index of the item representing the \c deAcceleratorEvents flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			///   \sa TBarCtlsLibA::DisabledEventsConstants
			/// \endif
			int deAcceleratorEvents;
			/// \brief <em>Holds the zero-based index of the item representing the \c deRawMenuMessage flag</em>
			///
			/// \if UNICODE
			///   \sa TBarCtlsLibU::DisabledEventsConstants
			/// \else
			...
			void Reset(void)
			{
				...
				deClickEvents = -2;
				deKeyboardEvents = -2;
				deBandInsertionEvents = -2;
				deButtonInsertionEvents = -2;
				deBandDeletionEvents = -2;
				deButtonDeletionEvents = -2;
				deFreeBandData = -2;
				deFreeButtonData = -2;
				deCustomDraw = -2;
				deHotButtonChangeEvents = -2;
				deAcceleratorEvents = -2;
				deRawMenuMessage = -2;
			}
		} disabledEventsItemIndices;
